...
import {saveLocation, fetchLocation} from './../../actions/shootingLocationActions';
...
class EditLocation extends Component {
	constructor(props){
		...
		this.state = {			
		   location : this.props.editlocation,
		   errors : {},
		   isLoading: false
		}         
	...
	onSubmit(e){
		...
		if(this.isValid()){
			...
			this.props.saveLocation(myId, location).then(
			(data) => {
			...
			<div class="col-lg-12">
				...
				<div id="add-listing">
					<div class="add-listing-section">
						...
						<div class="row with-forms">
							<div class="col-md-12">
								...
								<input type="text" class="search-field input-text" name="locationName" id="locationName" value={this.state.location.locationName} onChange={this.onChange} />								
                       			 {errors.locationName && <span style={{color : 'red'}} className="help-block">{errors.locationName}</span>}                    
							</div>
						</div>
						<div class="row with-forms">
							<div class="col-md-6">
					...
					<div className="form-group">
                 		<input type="submit" class="button border fw margin-top-10" name="addlocation" value="Save" />
                	</div>   
				</div>
			</div>
			<div class="col-md-12">
...
function mapStateToProps(state, props) {	
	const loggedInId =  state.auth.user.id;
	console.log("own props");
	console.log(props.match.params);
	if(props.match.params.locationId){
		console.log("LOCATION ID GOT ");	
		console.log(state.myLocations);	
		debugger		
		return {
			loggedInId : loggedInId,
			locationId : props.match.params.locationId,
			editlocation : state.myLocations.find(
...
export default connect(mapStateToProps, {saveLocation, fetchLocation})(EditLocation);