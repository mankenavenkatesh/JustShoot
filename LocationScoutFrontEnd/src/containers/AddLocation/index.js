...
class AddLocation extends Component {
	...
	onSubmit(e){
		...
		if(this.isValid()){
			...
			this.props.saveLocation(myId, {locationName}).then(
			(data) => {
					...
					<div class="add-listing-section">
						...
						<div class="row with-forms">
							<div class="col-md-12">
								...
								<input type="text" class="search-field input-text" name="locationName" id="locationName" value={this.props.locationName} onChange={this.onChange} />								
...
export default connect(mapStateToProps, {saveLocation})(AddLocation);