        ...
        <div class="row">
          <div class="col-lg-6 col-md-12">
            <div class="dashboard-list-box with-icons margin-top-20">
              ...
              <ul>
                <li>
                  <i class="list-box-icon sl sl-icon-layers" /> Your listing{" "}
                  <strong>
                ...
                <li>
                  <i class="list-box-icon sl sl-icon-star" /> Kathy Brown left a
                  review <div class="numerical-rating" data-rating="5.0" /> on{" "}
                  <strong>
                ...
                <li>
                  <i class="list-box-icon sl sl-icon-heart" /> Someone
                  bookmarked your{" "}
                  <strong>
                    <a href="#">Burger House</a>
                  </strong>{" "}
                ...
                <li>
                  <i class="list-box-icon sl sl-icon-star" /> Kathy Brown left a
                  review <div class="numerical-rating" data-rating="3.0" /> on{" "}
                  <strong>
                    <a href="#">Airport</a>
                  </strong>
                  <a href="#" class="close-list-item">
                ...
                <li>
                  <i class="list-box-icon sl sl-icon-star" /> John Doe left a
                  review <div class="numerical-rating" data-rating="4.0" /> on{" "}
                  <strong>
                    <a href="#">Burger House</a>
                  </strong>
                  <a href="#" class="close-list-item">
                ...
                <li>
                  <i class="list-box-icon sl sl-icon-star" /> Jack Perry left a
                  review <div class="numerical-rating" data-rating="2.5" /> on{" "}
                  <strong>
          ...
          <div class="col-lg-6 col-md-12">
            <div class="dashboard-list-box invoices with-icons margin-top-20">
              ...
              <ul>
                <li>
                  <i class="list-box-icon sl sl-icon-doc" />
